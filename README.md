...
To run the simulation , go to run.m. At the top of the document, there are sample confirations where in an agents start, goal , and desired velocity max are specified for 
